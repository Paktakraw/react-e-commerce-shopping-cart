...
// กดรูปที่หน้าเว็บ เเล้วรูปขยาย พร้อมมี description
const ItemDetail = () => {
      ...
      <div className="lg:flex items-center justify-center">
        ...
        <div>
          ...
          <p className="max-w-[400px] mb-4">
            ...
            quod nihil laudantium sint in repudiandae pariatur, magni obcaecati
            ab officia fugit, illo corrupti eaque ducimus.
          </p>
          <button
